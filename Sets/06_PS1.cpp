...
invite list with her friend Aashi. She asks Aashi to tell her names to add to the list. Aashii is 
a random guy and keeps coming up with names of people randomly to add to the invite list, even if 
the name is already on the list! Cherry hates redundancy and hence, enlists the names only once. 
